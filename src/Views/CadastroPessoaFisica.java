...
import virandoocapeta.PessoaFisica;
...
public class CadastroPessoaFisica extends javax.swing.JFrame {
    ...
    public void cadastrarPessoaFisica(){
        ...
        pf.setRg(Integer.parseInt(txtRG.getText()));
        pf.setCpf(Integer.parseInt(txtCPF.getText()));
        ...
        pf.setDdd(Integer.parseInt(txtDDD.getText()));
        pf.setTelefone(Integer.parseInt(txtTelefone.getText()));
        pf.setTipo(txtTipo.getText());
